        ...
        <div class="row mt-5">
            <div class="col-12">
                ...
                <form action="edit_course.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="d-sm-flex justify-content-end mt-2">
                        <input type="hidden" name="submit_price" value="<?php echo $courseId?>"> <button type="submit" class="btn btn-sm btn-primary mb-3">Change Duration</button>
                ...
                <form action="edit_course.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="d-sm-flex justify-content-end mt-2">
                        <input type="hidden" name="submit_image" value="<?php echo $courseId?>"> <button type="submit" class="btn btn-sm btn-primary mb-3">Change Image</button>
                    </div>
                </form> 
