...
<nav class="nav navbar-expand-sm bg-dark navbar-dark justify-content-center">
    <a class="nav-link" style="color : aliceblue;" href="./home.php">Student</a>
        <a class="nav-link" style="color : aliceblue;" href="#k1">Instructor</a>
        <a class="nav-link" style="color : aliceblue;" href="#k2">Course</a>
        <a class="nav-link" style="color : aliceblue;" href="#k3">Lesson</a>
        <a class="nav-link" style="color : aliceblue;" href="#k4">Payment</a>
        <a class="nav-link" style="color : aliceblue;" href="#k5">Enrollment</a>
...
<body class=" bg-secondary text-white">
   ...
   <div class="px-4 py-5 my-5 text-center bg-light text-dark">
            ...
            <div class="col-lg-12 mx-auto">
                ...
                <?php
                    $sql = "SELECT S.stu_id,U.fname,U.lname,P.Ddate,P.Ttime,P.file_name ,C.title,C.course_id,E.enroll_id
