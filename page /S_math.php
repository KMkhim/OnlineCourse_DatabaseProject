...
<body>
    ...
    <div class="px-4 py-5 my-5 text-center">
        ...
        <h1 class="display-5 fw-bold text-body-emphasis">Mathematics Site</h1>
        <div class="col-lg-6 mx-auto">
            <p class="lead mb-4">คณิตศาสตร์สุดสนุก</p>
            <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                <button type="button" class="btn btn-outline-secondary btn-lg px-4" ><a href="#math1">ประถม</a></button>
                <button type="button" class="btn btn-outline-secondary btn-lg px-4" ><a href="#math2">ม.ต้น</a></button>
                <button type="button" class="btn btn-outline-secondary btn-lg px-4" ><a href="#math3">ม.ปลาย</a></button>
            </div>
        </div>
...
<!-- <h2 id="math3">คณิตศาสตร์ระดับมัธยมปลาย</h2> -->
<div class="container marketing">
    ...
    <div class="row ">
        <!-- วิชาคณิตศาสตร์  -->
        <?php  
            $stmt = $conn->prepare("SELECT * FROM Courses WHERE category LIKE 'MA1%' ORDER BY updated_at DESC ");
            $stmt->execute();
        ...
        <div class="album py-5 bg-body-tertiary">
            <h2 class="featurette-heading fw-normal lh-1" id="math1">วิชาคณิตศาสตร์ระดับประถม <span class="text-body-secondary"> .... </span></h2>
            <br>
            <div class="container">
        ...
        <!-- END วิชาคณิตศาสตร์  -->
        <hr class="#">
         <!-- วิชาคณิตศาสตร์ มัธยมต้น -->
         <?php  
            $stmt = $conn->prepare("SELECT * FROM Courses WHERE category LIKE 'MA2%' ORDER BY updated_at DESC ");
            $stmt->execute();
            $rowCount = $stmt->rowCount();
        ?>
        <?php if($rowCount > 0 ): ?>
        ...
        <div class="album py-5 bg-body-tertiary">
            <h2 class="featurette-heading fw-normal lh-1" id="math2">วิชาคณิตศาสตร์ระดับมัธยมต้น<span class="text-body-secondary"> .... </span></h2>
            <br>
            <div class="container">
        ...
        <!-- END วิชาคณิตศาสตร์  -->
        <hr class="#">
         <!-- วิชาคณิตศาสตร์ มัธยมปลาย -->
         <?php  
            $stmt = $conn->prepare("SELECT * FROM Courses WHERE category LIKE 'MA3%' ORDER BY updated_at DESC ");
            $stmt->execute();
            $rowCount = $stmt->rowCount();
        ?>
        <?php if($rowCount > 0 ): ?>
        ...
        <div class="album py-5 bg-body-tertiary">
            <h2 class="featurette-heading fw-normal lh-1" id="math3">วิชาคณิตศาสตร์ระดับมัธยมปลาย<span class="text-body-secondary"> .... </span></h2>
            <br>
            <div class="container">
